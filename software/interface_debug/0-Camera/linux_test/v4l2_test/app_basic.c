...
//	parms.parm.capture.capturemode = V4L2_MODE_VIDEO; //V4L2_MODE_IMAGE
	parms.parm.capture.capturemode = 0; //V4L2_MODE_IMAGE
...
static int camera_fmt_set(int subch, int angle)
{
	...
	fmt.fmt.pix.field       	= V4L2_FIELD_INTERLACED;//V4L2_FIELD_NONE;			//V4L2_FIELD_INTERLACED;//V4L2_FIELD_NONE;
...
int main(int argc,char *argv[])
{
    ...
    printf("dev_name:%s,sel:%d,width:%d,height:%d,path_name:%d,mode:%d,test_cnt:%d\n",
            dev_name,sel,width,height,path_name,mode,test_cnt);
